...
#include "cxlalloc.hpp"
// #include <libcuckoo/cuckoohash_map.hh>

namespace bip = boost::interprocess;

int main(void) {
	typedef std::basic_string<char, std::char_traits<char>, CXLAlloc<char>> cxl_string;
	...
	typedef oneapi::tbb::concurrent_hash_map<cxl_string, cxl_string, CXLAlloc<cxl_string>> CxlAllocHashMap;
	...
	cxlalloc_init("region", 1024*1024*1024, 2, 1);
	CxlAllocHashMap cxl_hash_map;
}
